...
public class calcola {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			Testo=new FileReader("C:\\Users\\Michele\\Desktop\\Coding\\HC_18\\V_2\\googlehashcode\\src\\d_metropolis_dummy.in");
		...
		File file = new File("C:\\Users\\Michele\\Desktop\\Coding\\HC_18\\V_2\\googlehashcode\\src\\d_dummy.txt"); //Your file
	...
	public int migliorCorsa(Corsa[] corse, Veicolo v, calcola c, int t)
	{
		...
		System.out.println("Corsa migliore "+C_migliore+" per il driver "+v.Id);
		if(C_migliore!=-1){
